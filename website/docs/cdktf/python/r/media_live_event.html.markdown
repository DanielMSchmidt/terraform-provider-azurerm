...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.media_live_event.MediaLiveEvent(self, "example_3",
            ...
            preview=MediaLiveEventPreview(
                ip_access_control_allow=[MediaLiveEventPreviewIpAccessControlAllow(
                    address="0.0.0.0",
                    name="AllowAll",
                    subnet_prefix_length=0
                )
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c55626014c9cd622d413549fe22eb6cee52415e321a8c2748e65f3823f1dcf38 -->