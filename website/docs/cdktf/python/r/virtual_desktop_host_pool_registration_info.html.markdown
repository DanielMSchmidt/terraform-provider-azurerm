...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.virtual_desktop_host_pool.VirtualDesktopHostPool(self, "example_1",
        ...
        azurerm_virtual_desktop_host_pool_registration_info_example =
        azurerm.virtual_desktop_host_pool_registration_info.VirtualDesktopHostPoolRegistrationInfo(self, "example_2",
            expiration_date="2022-01-01T23:40:52Z",
            hostpool_id=cdktf.Token.as_string(azurerm_virtual_desktop_host_pool_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_virtual_desktop_host_pool_registration_info_example.override_logical_id("example")
```
