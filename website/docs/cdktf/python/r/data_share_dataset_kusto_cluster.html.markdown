    ...
    def __init__(self, scope, name):
        ...
        azurerm.role_assignment.RoleAssignment(self, "example_4",
            principal_id=cdktf.Token.as_string(
                cdktf.property_access(azurerm_data_share_account_example.identity, ["0", "principal_id"
                ])),
            role_definition_name="Contributor",
            scope=cdktf.Token.as_string(azurerm_kusto_cluster_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_role_assignment_example.override_logical_id("example")
        azurerm_data_share_example = azurerm.data_share.DataShare(self, "example_5",
        ...
        azurerm_data_share_dataset_kusto_cluster_example =
        azurerm.data_share_dataset_kusto_cluster.DataShareDatasetKustoCluster(self, "example_6",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_data_share_dataset_kusto_cluster_example.override_logical_id("example")
```
