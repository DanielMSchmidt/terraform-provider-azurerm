...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.data_azurerm_virtual_network.DataAzurermVirtualNetwork(self, "example_1",
            name="production",
            resource_group_name="networking"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_azurerm_virtual_network_example.override_logical_id("example")
        azurerm_resource_policy_assignment_example =
        azurerm.resource_policy_assignment.ResourcePolicyAssignment(self, "example_2",
            name="example-policy-assignment",
            policy_definition_id=cdktf.Token.as_string(azurerm_policy_definition_example.id),
            resource_id=cdktf.Token.as_string(data_azurerm_virtual_network_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-2a406deb0165554a8ff2c623b34fe9a0a8745c14784443d7dd61440aee4edd55 -->