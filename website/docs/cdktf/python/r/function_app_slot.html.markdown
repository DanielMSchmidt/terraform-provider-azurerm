...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_function_app_example = azurerm.function_app.FunctionApp(self, "example_3",
        ...
        azurerm_function_app_slot_example =
        azurerm.function_app_slot.FunctionAppSlot(self, "example_4",
            app_service_plan_id=cdktf.Token.as_string(azurerm_app_service_plan_example.id),
            function_app_name=cdktf.Token.as_string(azurerm_function_app_example.name),
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_function_app_slot_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c497f6db24e8125ebe24ae1faf15acb033761174f24eec8730c0c507bdfaf69c -->