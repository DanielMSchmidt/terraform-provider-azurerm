...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.synapse_workspace_aad_admin.SynapseWorkspaceAadAdminA(self, "example_8",
            login="AzureAD Admin",
            object_id=cdktf.Token.as_string(data_azurerm_client_config_current.object_id),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-ed716a43146a1f618c43907d472611fda7d9a82101b9997f41dfb53eef4cc251 -->