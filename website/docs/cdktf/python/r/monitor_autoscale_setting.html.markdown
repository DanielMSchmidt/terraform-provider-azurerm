...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.linux_virtual_machine_scale_set.LinuxVirtualMachineScaleSet(self, "example_3",
            admin_ssh_key=[LinuxVirtualMachineScaleSetAdminSshKey(
        ...
        azurerm_monitor_autoscale_setting_example =
        azurerm.monitor_autoscale_setting.MonitorAutoscaleSetting(self, "example_4",
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
            ...
            profile=[MonitorAutoscaleSettingProfile(
                ...
                name="defaultProfile",
                rule=[MonitorAutoscaleSettingProfileRule(
                    metric_trigger=MonitorAutoscaleSettingProfileRuleMetricTrigger(
                        dimensions=[MonitorAutoscaleSettingProfileRuleMetricTriggerDimensions(
                            name="AppName",
                            operator="Equals",
                            values=["App1"]
                        )
                        ...
                        metric_resource_id=cdktf.Token.as_string(azurerm_linux_virtual_machine_scale_set_example.id),
            ...
            resource_group_name=cdktf.Token.as_string(azurerm_resource_group_example.name),
            target_resource_id=cdktf.Token.as_string(azurerm_linux_virtual_machine_scale_set_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_monitor_autoscale_setting_example.override_logical_id("example")
```
