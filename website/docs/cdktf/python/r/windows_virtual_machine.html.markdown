...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.windows_virtual_machine.WindowsVirtualMachine(self, "example_5",
...
* ``computer_name`- (Optional) Specifies the Hostname which should be used for this Virtual Machine. If unspecified this defaults to the value for the ``name`field. If the value of the ``name`field is not a valid ``computer_`name`then you must specify ``computer_`name`Changing this forces a new resource to be created.
...
* ``secure_vm_disk_encryption_set_id`- (Optional) The ID of the Disk Encryption Set which should be used to Encrypt this OS Disk when the Virtual Machine is a Confidential VM. Conflicts with ``disk_encryption_set_`id`Changing this forces a new resource to be created.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6ade1f207788ed5a01ac1b062b45f862808bf418ac4ca61e2447f3b0f0ec9c84 -->