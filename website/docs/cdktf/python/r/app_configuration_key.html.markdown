...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_role_assignment_appconf_dataowner =
        ...
        azurerm.app_configuration_key.AppConfigurationKey(self, "test",
            configuration_store_id=cdktf.Token.as_string(azurerm_app_configuration_appconf.id),
            depends_on=[azurerm_role_assignment_appconf_dataowner],
            key="appConfKey1",
            label="somelabel",
            value="a test"
        )
