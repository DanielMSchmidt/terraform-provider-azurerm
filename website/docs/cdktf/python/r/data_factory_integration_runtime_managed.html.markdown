...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_data_factory_integration_runtime_managed_example =
        azurerm.data_factory_integration_runtime_managed.DataFactoryIntegrationRuntimeManaged(self, "example_2",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_data_factory_integration_runtime_managed_example.override_logical_id("example")
```
