    ...
    def __init__(self, scope, name):
        ...
        azurerm_netapp_volume_example = azurerm.netapp_volume.NetappVolume(self, "example_5",
            ...
            data_protection_replication=NetappVolumeDataProtectionReplication(
                endpoint_type="dst",
                remote_volume_location=cdktf.Token.as_string(azurerm_resource_group_example.location),
                remote_volume_resource_id=cdktf.Token.as_string(azurerm_netapp_volume_example.id),
