    ...
    def __init__(self, scope, name):
        ...
        azurerm.cosmosdb_sql_container.CosmosdbSqlContainer(self, "example_2",
            ...
            indexing_policy=CosmosdbSqlContainerIndexingPolicy(
                excluded_path=[CosmosdbSqlContainerIndexingPolicyExcludedPath(
                    path="/excluded/?"
                )
                ],
                included_path=[CosmosdbSqlContainerIndexingPolicyIncludedPath(
                    path="/*"
            ...
            resource_group_name=cdktf.Token.as_string(data_azurerm_cosmosdb_account_example.resource_group_name),
            throughput=400,
            unique_key=[CosmosdbSqlContainerUniqueKey(
