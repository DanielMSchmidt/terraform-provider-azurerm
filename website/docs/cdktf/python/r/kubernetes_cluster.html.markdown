...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        cdktf.TerraformOutput(self, "client_certificate",
            value=cdktf.property_access(azurerm_kubernetes_cluster_example.kube_config, ["0", "client_certificate"
            ]),
            sensitive=True
        )
        cdktf.TerraformOutput(self, "kube_config",
            value=azurerm_kubernetes_cluster_example.kube_config_raw,
            sensitive=True
        )
```
        ...
        kubernetes.provider.KubernetesProvider(self, "kubernetes",
            client_certificate=cdktf.Fn.base64decode(
                cdktf.Token.as_string(
                    cdktf.property_access(azurerm_kubernetes_cluster_main.kube_config, ["0", "client_certificate"
                    ]))),
            client_key=cdktf.Fn.base64decode(
                cdktf.Token.as_string(
                    cdktf.property_access(azurerm_kubernetes_cluster_main.kube_config, ["0", "client_key"
                    ]))),
            cluster_ca_certificate=cdktf.Fn.base64decode(
                cdktf.Token.as_string(
                    cdktf.property_access(azurerm_kubernetes_cluster_main.kube_config, ["0", "cluster_ca_certificate"
                    ]))),
            host=cdktf.property_access(azurerm_kubernetes_cluster_main.kube_config, ["0", "host"
            ]),
            password=cdktf.property_access(azurerm_kubernetes_cluster_main.kube_config, ["0", "password"
            ]),
            username=cdktf.property_access(azurerm_kubernetes_cluster_main.kube_config, ["0", "username"
            ])
        )
```
