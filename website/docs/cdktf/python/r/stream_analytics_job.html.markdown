...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.stream_analytics_job.StreamAnalyticsJob(self, "example_1",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a6e1d5cf715db8af3bd8096b248d11aaac8ebfa289a614efd14c92cec65c0cec -->