...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_synapse_workspace_security_alert_policy_example =
        azurerm.synapse_workspace_security_alert_policy.SynapseWorkspaceSecurityAlertPolicy(self, "example_5",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_synapse_workspace_security_alert_policy_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-24d8b8149cbcdcccf91fbeb9b17ee064a13fd056de61c308bf570e66d19c53e9 -->