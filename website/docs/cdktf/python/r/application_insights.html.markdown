...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        cdktf.TerraformOutput(self, "app_id",
            value=azurerm_application_insights_example.app_id
        )
        cdktf.TerraformOutput(self, "instrumentation_key",
            value=azurerm_application_insights_example.instrumentation_key
        )
```
