...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_hdinsight_interactive_query_cluster_example =
        azurerm.hdinsight_interactive_query_cluster.HdinsightInteractiveQueryCluster(self, "example_3",
            cluster_version="3.6",
            ...
            storage_account=[HdinsightInteractiveQueryClusterStorageAccount(
                is_default=True,
                storage_account_key=cdktf.Token.as_string(azurerm_storage_account_example.primary_access_key),
                storage_container_id=cdktf.Token.as_string(azurerm_storage_container_example.id)
            )
            ],
            tier="Standard"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_hdinsight_interactive_query_cluster_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-f97a932a21da235162d2472047f51eea0a4f6e36e27d8146824945104136cde4 -->