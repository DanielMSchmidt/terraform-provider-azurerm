...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.healthcare_service.HealthcareService(self, "example",
            access_policy_object_ids=cdktf.Token.as_list(data_azurerm_client_config_current.object_id),
            authentication_configuration=HealthcareServiceAuthenticationConfiguration(
                audience="https://azurehealthcareapis.com/",
                authority="https://login.microsoftonline.com/$%7Bdata.azurerm_client_config.current.tenant_id%7D",
                smart_proxy_enabled=cdktf.Token.as_boolean("true")
            ),
            cors_configuration=HealthcareServiceCorsConfiguration(
                allow_credentials=cdktf.Token.as_boolean("true"),
                allowed_headers=["x-tempo-*", "x-tempo2-*"],
                allowed_methods=["GET", "PUT"],
                allowed_origins=["http://www.example.com", "http://www.example2.com"],
                max_age_in_seconds=cdktf.Token.as_number("500")
            ),
            cosmosdb_throughput=cdktf.Token.as_number("2000"),
            kind="fhir-R4",
            location="westus2",
            name="uniquefhirname",
