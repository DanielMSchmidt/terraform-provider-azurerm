...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.eventgrid_event_subscription.EventgridEventSubscription(self, "example_3",
            name="example-aees",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e6dc0c927bf0ddc74425792c9312dee860981d56f56dac1f6fd085acc704898a -->