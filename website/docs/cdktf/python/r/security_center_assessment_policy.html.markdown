...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.security_center_assessment_policy.SecurityCenterAssessmentPolicy(self, "example",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5849c62e7565cba8ce24ccc1645aebd955197b0c572ed989aa262e0b78ce137c -->