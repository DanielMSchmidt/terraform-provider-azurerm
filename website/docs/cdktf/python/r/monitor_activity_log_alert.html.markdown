...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_monitor_activity_log_alert_main =
        azurerm.monitor_activity_log_alert.MonitorActivityLogAlert(self, "main_3",
            action=[MonitorActivityLogAlertAction(
            ...
            criteria=MonitorActivityLogAlertCriteria(
                ...
                resource_id=cdktf.Token.as_string(azurerm_storage_account_to_monitor.id)
            ),
        ...
        azurerm_monitor_activity_log_alert_main.override_logical_id("main")
```
