...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_container_group_example =
        azurerm.container_group.ContainerGroup(self, "example_1",
            container=[ContainerGroupContainer(
                cpu=cdktf.Token.as_number("0.5"),
                image="mcr.microsoft.com/azuredocs/aci-helloworld:latest",
                memory=cdktf.Token.as_number("1.5"),
                name="hello-world",
                ports=[ContainerGroupContainerPorts(
                    port=443,
                    protocol="TCP"
                )
                ]
        ...
        azurerm_container_group_example.override_logical_id("example")
```
