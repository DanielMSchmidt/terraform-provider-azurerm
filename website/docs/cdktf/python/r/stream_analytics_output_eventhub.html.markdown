...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_stream_analytics_output_eventhub_example =
        azurerm.stream_analytics_output_eventhub.StreamAnalyticsOutputEventhub(self, "example_4",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_stream_analytics_output_eventhub_example.override_logical_id("example")
```
