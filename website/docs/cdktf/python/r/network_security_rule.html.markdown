...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_network_security_rule_example =
        azurerm.network_security_rule.NetworkSecurityRule(self, "example_2",
            access="Allow",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_network_security_rule_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a1a38df8244e0e0541c82ce7346451d78e7867d543dc18b8c31ca367b3d1e1ea -->