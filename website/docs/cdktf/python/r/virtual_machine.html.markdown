...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.network_interface.NetworkInterface(self, "main_4",
        ...
        azurerm_virtual_machine_main = azurerm.virtual_machine.VirtualMachine(self, "main_5",
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_virtual_machine_main.override_logical_id("main")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9809768d5ffdf686d9987ca74e3dfa0aff603ee3188eb4d95422829a83a0d800 -->