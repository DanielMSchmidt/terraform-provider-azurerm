...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.kubernetes_cluster.KubernetesCluster(self, "example_1",
            ...
            service_principal=KubernetesClusterServicePrincipal(
        ...
        azurerm_kubernetes_cluster_node_pool_example =
        azurerm.kubernetes_cluster_node_pool.KubernetesClusterNodePool(self, "example_2",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_kubernetes_cluster_node_pool_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-3f2dc231f88021ce236bd0092248df49a14653386a7af6e372e7497b56e663fe -->