...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_logic_app_trigger_recurrence_example =
        azurerm.logic_app_trigger_recurrence.LogicAppTriggerRecurrence(self, "example_2",
            frequency="Day",
            interval=1,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_logic_app_trigger_recurrence_example.override_logical_id("example")
```
