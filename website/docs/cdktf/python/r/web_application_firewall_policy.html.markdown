...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_web_application_firewall_policy_example =
        azurerm.web_application_firewall_policy.WebApplicationFirewallPolicy(self, "example_1",
            custom_rules=[WebApplicationFirewallPolicyCustomRules(
                action="Block",
                match_conditions=[WebApplicationFirewallPolicyCustomRulesMatchConditions(
                    match_values=["192.168.1.0/24", "10.0.0.0/24"],
                    match_variables=[WebApplicationFirewallPolicyCustomRulesMatchConditionsMatchVariables(
            ...
            managed_rules=WebApplicationFirewallPolicyManagedRules(
                exclusion=[WebApplicationFirewallPolicyManagedRulesExclusion(
                ...
                managed_rule_set=[WebApplicationFirewallPolicyManagedRulesManagedRuleSet(
                    rule_group_override=[WebApplicationFirewallPolicyManagedRulesManagedRuleSetRuleGroupOverride(
                        rule=[WebApplicationFirewallPolicyManagedRulesManagedRuleSetRuleGroupOverrideRule(
                            action="Log",
                            enabled=True,
                            id="920300"
        ...
        azurerm_web_application_firewall_policy_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-00f3eb81ea17b585f946b040ec8e6658d827093d552aeab34d272c0415482d5b -->