...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_storage_data_lake_gen2_path_example =
        azurerm.storage_data_lake_gen2_path.StorageDataLakeGen2Path(self, "example_3",
            filesystem_name=cdktf.Token.as_string(azurerm_storage_data_lake_gen2_filesystem_example.name),
            path="example",
            resource="directory",
            storage_account_id=cdktf.Token.as_string(azurerm_storage_account_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_storage_data_lake_gen2_path_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e19ed23fcf88b77b72a065468656641bd26c0b6fe4032c559ce4fa838d578146 -->