...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.spring_cloud_service.SpringCloudService(self, "example_3",
            ...
            trace=SpringCloudServiceTrace(
                connection_string=cdktf.Token.as_string(azurerm_application_insights_example.connection_string),
                sample_rate=10
            )
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8bb932ce57742c174a1538e0878ee0bbfd27dc119fcfe8f60baf0fd6d7970ec6 -->