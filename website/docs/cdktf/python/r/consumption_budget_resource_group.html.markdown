...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_consumption_budget_resource_group_example =
        azurerm.consumption_budget_resource_group.ConsumptionBudgetResourceGroup(self, "example_2",
            amount=1000,
            filter=ConsumptionBudgetResourceGroupFilter(
                dimension=[ConsumptionBudgetResourceGroupFilterDimension(
                    name="ResourceId",
                    values=[
                ...
                tag=[ConsumptionBudgetResourceGroupFilterTag(
                    name="foo",
                    values=["bar", "baz"]
                )
                ]
            ...
            name="example",
            notification=[ConsumptionBudgetResourceGroupNotification(
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_consumption_budget_resource_group_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e8e6be383ddf272745bd1a9397b4e1958d33710c691eb4583a31f06451373de2 -->