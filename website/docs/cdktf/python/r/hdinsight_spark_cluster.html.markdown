...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_hdinsight_spark_cluster_example =
        azurerm.hdinsight_spark_cluster.HdinsightSparkCluster(self, "example_3",
            cluster_version="3.6",
            ...
            storage_account=[HdinsightSparkClusterStorageAccount(
                is_default=True,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_hdinsight_spark_cluster_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e2c3650eb7551ea4f27d88a4782913647f4f56506813b47ac22c99b3d0f2d955 -->