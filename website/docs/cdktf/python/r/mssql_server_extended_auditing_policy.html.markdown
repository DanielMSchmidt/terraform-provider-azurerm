...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_mssql_server_extended_auditing_policy_example =
        azurerm.mssql_server_extended_auditing_policy.MssqlServerExtendedAuditingPolicy(self, "example_4",
            retention_in_days=6,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_mssql_server_extended_auditing_policy_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c4ac1b87d9b16b83cb73f04f818503f0d21c9ae420ee015992f50e5077020d9c -->