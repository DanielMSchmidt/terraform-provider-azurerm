...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_active_directory_domain_service_example =
        azurerm.data_azurerm_active_directory_domain_service.DataAzurermActiveDirectoryDomainService(self, "example",
            name="example-ds",
            resource_group_name="example-rg"
        )
        azurerm_active_directory_domain_service_trust_example =
        azurerm.active_directory_domain_service_trust.ActiveDirectoryDomainServiceTrust(self, "example_2",
            domain_service_id=cdktf.Token.as_string(data_azurerm_active_directory_domain_service_example.id),
            name="example-trust",
        ...
        azurerm_active_directory_domain_service_trust_example.override_logical_id("example")
```
