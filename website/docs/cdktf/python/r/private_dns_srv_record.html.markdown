...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_private_dns_srv_record_example =
        azurerm.private_dns_srv_record.PrivateDnsSrvRecord(self, "example_2",
            name="test",
            record=[PrivateDnsSrvRecordRecord(
                port=8080,
                priority=1,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_private_dns_srv_record_example.override_logical_id("example")
```
