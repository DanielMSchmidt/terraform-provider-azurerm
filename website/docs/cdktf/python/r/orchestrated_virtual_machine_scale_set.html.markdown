...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_orchestrated_virtual_machine_scale_set_example =
        azurerm.orchestrated_virtual_machine_scale_set.OrchestratedVirtualMachineScaleSet(self, "example_1",
        ...
        azurerm_orchestrated_virtual_machine_scale_set_example.override_logical_id("example")
```
