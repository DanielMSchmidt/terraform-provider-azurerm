...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_app_service_environment_v3_example =
        azurerm.app_service_environment_v3.AppServiceEnvironmentV3(self, "example_3",
            cluster_setting=[AppServiceEnvironmentV3ClusterSetting(
                name="DisableTls1.0",
                value="1"
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_app_service_environment_v3_example.override_logical_id("example")
        azurerm_service_plan_example = azurerm.service_plan.ServicePlan(self, "example_4",
            app_service_environment_id=cdktf.Token.as_string(azurerm_app_service_environment_v3_example.id),
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
            name="example",
            os_type="Linux",
            resource_group_name=cdktf.Token.as_string(azurerm_resource_group_example.name),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-38abc796e8e37a0316fd4857d8bb62b4fbf0f12a56603e14ef8b06553e88dd52 -->