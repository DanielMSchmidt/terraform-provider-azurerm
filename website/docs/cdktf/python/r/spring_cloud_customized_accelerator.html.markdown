...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_spring_cloud_customized_accelerator_example =
        azurerm.spring_cloud_customized_accelerator.SpringCloudCustomizedAccelerator(self, "example_4",
            ...
            name="example",
            spring_cloud_accelerator_id=cdktf.Token.as_string(azurerm_spring_cloud_accelerator_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_spring_cloud_customized_accelerator_example.override_logical_id("example")
```
