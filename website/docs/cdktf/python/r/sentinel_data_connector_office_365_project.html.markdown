...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_sentinel_data_connector_office365_project_example =
        azurerm.sentinel_data_connector_office365_project.SentinelDataConnectorOffice365Project(self, "example_3",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_sentinel_data_connector_office365_project_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-64b660f3e735f4bf9bd7c5e94b564d46db00e7856f56b4b0f5995576f530fc17 -->