    ...
    def __init__(self, scope, name):
        ...
        azurerm.virtual_network_gateway.VirtualNetworkGateway(self, "example_4",
            ...
            vpn_client_configuration=VirtualNetworkGatewayVpnClientConfiguration(
                ...
                revoked_certificate=[VirtualNetworkGatewayVpnClientConfigurationRevokedCertificate(
                    name="Verizon-Global-Root-CA",
                    thumbprint="912198EEF23DCAC40939312FEE97DD560BAE49B1"
                )
                ],
                root_certificate=[VirtualNetworkGatewayVpnClientConfigurationRootCertificate(
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-54414ad0c3be9cf3aa6b81165ea590f7329676f4c33137cf50470f3948e85bb2 -->