...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_stream_analytics_output_servicebus_topic_example =
        azurerm.stream_analytics_output_servicebus_topic.StreamAnalyticsOutputServicebusTopic(self, "example_4",
            ...
            topic_name=cdktf.Token.as_string(azurerm_servicebus_topic_example.name)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_stream_analytics_output_servicebus_topic_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-68bed3eebab652623dc53256361b8c319442c31eee12e505bf8a48fcfec1a410 -->