...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.analysis_services_server.AnalysisServicesServer(self, "server",
            admin_users=["myuser@domain.tld"],
            enable_power_bi_service=True,
            ipv4_firewall_rule=[AnalysisServicesServerIpv4FirewallRule(
                name="myRule1",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e697fec96256deaf6c4b0dbff151e21d2d8780092c011f672d281284e61f698b -->