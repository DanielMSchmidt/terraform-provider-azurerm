...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_managed_disk_source = azurerm.managed_disk.ManagedDisk(self, "source",
            create_option="Empty",
            disk_size_gb=cdktf.Token.as_number("1"),
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
            name="acctestmd1",
        ...
        azurerm.managed_disk.ManagedDisk(self, "copy",
            create_option="Copy",
            disk_size_gb=cdktf.Token.as_number("1"),
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
            name="acctestmd2",
            resource_group_name=cdktf.Token.as_string(azurerm_resource_group_example.name),
            source_resource_id=cdktf.Token.as_string(azurerm_managed_disk_source.id),
            storage_account_type="Standard_LRS",
            tags={
                "environment": "staging"
            }
