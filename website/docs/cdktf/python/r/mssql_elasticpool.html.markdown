...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_mssql_elasticpool_example =
        azurerm.mssql_elasticpool.MssqlElasticpool(self, "example_2",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_mssql_elasticpool_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-2bbcb86eb200e9f5abb507828f22c10ce79c257c8bf616660240e626c4ca6d08 -->