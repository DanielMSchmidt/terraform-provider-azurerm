...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.mysql_flexible_server.MysqlFlexibleServer(self, "example_1",
        ...
        azurerm_mysql_flexible_server_firewall_rule_example =
        azurerm.mysql_flexible_server_firewall_rule.MysqlFlexibleServerFirewallRule(self, "example_2",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_mysql_flexible_server_firewall_rule_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c2b893523d422c41de789e615b90f08e9c6d5e319266bed0b891717fefb4da1e -->