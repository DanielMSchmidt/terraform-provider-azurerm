...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_sentinel_data_connector_office_irm_example =
        azurerm.sentinel_data_connector_office_irm.SentinelDataConnectorOfficeIrm(self, "example_3",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_sentinel_data_connector_office_irm_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0d865c58681d5bcf497dc8d3cfc8b504062587b3913546634440fc222b4dad4e -->