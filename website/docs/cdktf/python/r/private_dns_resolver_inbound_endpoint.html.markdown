...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_private_dns_resolver_inbound_endpoint_example =
        azurerm.private_dns_resolver_inbound_endpoint.PrivateDnsResolverInboundEndpoint(self, "example_4",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_private_dns_resolver_inbound_endpoint_example.override_logical_id("example")
```
