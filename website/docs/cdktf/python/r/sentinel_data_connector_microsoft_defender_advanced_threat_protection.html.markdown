...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_sentinel_data_connector_microsoft_defender_advanced_threat_protection_example =
        azurerm.sentinel_data_connector_microsoft_defender_advanced_threat_protection.SentinelDataConnectorMicrosoftDefenderAdvancedThreatProtection(self, "example_3",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_sentinel_data_connector_microsoft_defender_advanced_threat_protection_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-1ada9901b1cda96209d18c01b82f30306510730ba87294915d6583d7ec772fa8 -->