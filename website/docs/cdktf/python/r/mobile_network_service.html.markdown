...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.mobile_network_service.MobileNetworkService(self, "example_2",
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a8405ebb6733c10f7518888571dc573c58aae237824b0c716deb3771b77fb643 -->