...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_hdinsight_hbase_cluster_example =
        azurerm.hdinsight_hbase_cluster.HdinsightHbaseCluster(self, "example_3",
            cluster_version="3.6",
            ...
            storage_account=[HdinsightHbaseClusterStorageAccount(
                is_default=True,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_hdinsight_hbase_cluster_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0ecac748745ad0ade8d2d8d7cacdf9145ad5aabcf19aaba4958466b2bb89ba4a -->