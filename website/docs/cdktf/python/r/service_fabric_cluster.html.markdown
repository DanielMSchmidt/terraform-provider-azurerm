...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_service_fabric_cluster_example =
        azurerm.service_fabric_cluster.ServiceFabricCluster(self, "example_1",
            cluster_code_version="7.1.456.959",
            location=cdktf.Token.as_string(azurerm_resource_group_example.location),
            management_endpoint="https://example:80",
            name="example-servicefabric",
            node_type=[ServiceFabricClusterNodeType(
        ...
        azurerm_service_fabric_cluster_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-2f11b0d7989ce1d74055f7ef80f309f21989e6182da236b1ded2d04f526fe891 -->