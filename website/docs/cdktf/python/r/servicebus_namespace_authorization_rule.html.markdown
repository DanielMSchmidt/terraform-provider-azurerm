...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_servicebus_namespace_authorization_rule_example =
        azurerm.servicebus_namespace_authorization_rule.ServicebusNamespaceAuthorizationRule(self, "example_2",
            listen=True,
            manage=False,
            name="examplerule",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_servicebus_namespace_authorization_rule_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-22b141fb64a0e37aa3f33cbc616771b66a349cf16446c2dd05cee5e56451d2a9 -->