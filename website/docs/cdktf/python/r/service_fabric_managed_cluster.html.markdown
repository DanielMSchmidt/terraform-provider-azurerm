...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.service_fabric_managed_cluster.ServiceFabricManagedCluster(self, "example",
            client_connection_port=12345,
            http_gateway_port=4567,
            lb_rule=[ServiceFabricManagedClusterLbRule(
                backend_port=38080,
                frontend_port=80,
                probe_protocol="http",
            ...
            name="example",
            node_type=[ServiceFabricManagedClusterNodeType(
