...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_stream_analytics_stream_input_iothub_example =
        azurerm.stream_analytics_stream_input_iothub.StreamAnalyticsStreamInputIothub(self, "example_3",
            endpoint="messages/events",
            eventhub_consumer_group_name="$Default",
            iothub_namespace=cdktf.Token.as_string(azurerm_iothub_example.name),
            ...
            shared_access_policy_key=cdktf.Token.as_string(
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_stream_analytics_stream_input_iothub_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-436aa06cfdee29acce8d0fab01cf274049788a462c223d082224c00b3c7fd930 -->