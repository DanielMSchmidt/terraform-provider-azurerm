        ...
        azurerm.media_transform.MediaTransform(self, "example_3",
            ...
            output=[MediaTransformOutput(
                ...
                custom_preset=MediaTransformOutputCustomPreset(
                    codec=[MediaTransformOutputCustomPresetCodec(
                        ...
                        h264_video=MediaTransformOutputCustomPresetCodecH264Video(
                            ...
                            layer=[MediaTransformOutputCustomPresetCodecH264VideoLayer(
                                adaptive_bFrame_enabled=True,
                                b_frames=3,
                                bitrate=1045000,
                                buffer_window="PT5S",
                                crf=23,
                        ...
                        h265_video=MediaTransformOutputCustomPresetCodecH265Video(
                            ...
                            layer=[MediaTransformOutputCustomPresetCodecH265VideoLayer(
                                adaptive_bFrame_enabled=True,
                                b_frames=3,
                                bitrate=1045000,
                                buffer_window="PT5S",
                        ...
                        jpg_image=MediaTransformOutputCustomPresetCodecJpgImage(
                            layer=[MediaTransformOutputCustomPresetCodecJpgImageLayer(
                                height="180",
                                label="test",
                                quality=70,
                                width="120"
                        ...
                        png_image=MediaTransformOutputCustomPresetCodecPngImage(
                            layer=[MediaTransformOutputCustomPresetCodecPngImageLayer(
                                height="180",
                                label="test",
                                width="120"
                            )
                    ...
                    filter=MediaTransformOutputCustomPresetFilter(
                        ...
                        overlay=[MediaTransformOutputCustomPresetFilterOverlay(
                    ...
                    format=[MediaTransformOutputCustomPresetFormat(
                        jpg=MediaTransformOutputCustomPresetFormatJpg(
                        ...
                        mp4=MediaTransformOutputCustomPresetFormatMp4(
                            ...
                            output_file=[MediaTransformOutputCustomPresetFormatMp4OutputFile(
                                labels=["test", "ppe"]
                            )
                            ]
                        )
                    ), MediaTransformOutputCustomPresetFormat(
                        png=MediaTransformOutputCustomPresetFormatPng(
                            filename_pattern="test{Basename}"
                        )
                    ), MediaTransformOutputCustomPresetFormat(
                        transport_stream=MediaTransformOutputCustomPresetFormatTransportStream(
                            filename_pattern="test{Bitrate}",
                            output_file=[MediaTransformOutputCustomPresetFormatTransportStreamOutputFile(
                                labels=["prod"]
                            )
                            ]
                        )
