...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_container_app_example = azurerm.container_app.ContainerApp(self, "example_3",
            ...
            template=ContainerAppTemplate(
                container=[ContainerAppTemplateContainer(
                    cpu=0.25,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_container_app_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-cf1543f80675f89240451bccf429140a38eeffbbc08eace84a8a6824ce8af594 -->