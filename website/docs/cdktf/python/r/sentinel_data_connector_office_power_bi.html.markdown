...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_sentinel_data_connector_office_power_bi_example =
        azurerm.sentinel_data_connector_office_power_bi.SentinelDataConnectorOfficePowerBi(self, "example_3",
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_sentinel_data_connector_office_power_bi_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-654000315a95f21d0932b83f7f912aa6d628800a72ac1e197db212eeacffd117 -->