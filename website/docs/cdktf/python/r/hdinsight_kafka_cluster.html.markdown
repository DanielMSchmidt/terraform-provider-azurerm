...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_hdinsight_kafka_cluster_example =
        azurerm.hdinsight_kafka_cluster.HdinsightKafkaCluster(self, "example_3",
            cluster_version="4.0",
            ...
            storage_account=[HdinsightKafkaClusterStorageAccount(
                is_default=True,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_hdinsight_kafka_cluster_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-4d1e230ccc78a624153087fa3190eb049decf64d08ccc7d77cd3905779f76ab3 -->