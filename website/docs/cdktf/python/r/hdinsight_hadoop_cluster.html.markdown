...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_hdinsight_hadoop_cluster_example =
        azurerm.hdinsight_hadoop_cluster.HdinsightHadoopCluster(self, "example_3",
            cluster_version="3.6",
            ...
            storage_account=[HdinsightHadoopClusterStorageAccount(
                is_default=True,
        ...
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_hdinsight_hadoop_cluster_example.override_logical_id("example")
```
