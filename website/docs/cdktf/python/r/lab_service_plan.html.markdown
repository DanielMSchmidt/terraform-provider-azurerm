...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_lab_service_plan_example =
        azurerm.lab_service_plan.LabServicePlan(self, "example_1",
            allowed_regions=[
                cdktf.Token.as_string(azurerm_resource_group_example.location)
            ],
        ...
        azurerm_lab_service_plan_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-ca066165d9989832822e8edfa3ac2560e5afacc043615ff160680b0270c59e1a -->