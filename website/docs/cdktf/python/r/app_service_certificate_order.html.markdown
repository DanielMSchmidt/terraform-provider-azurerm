...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_app_service_certificate_order_example =
        azurerm.app_service_certificate_order.AppServiceCertificateOrder(self, "example_1",
        ...
        azurerm_app_service_certificate_order_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-49b68820ebacfb069d4e4f00104304162313878f58e93b5ff313b132ff572d10 -->