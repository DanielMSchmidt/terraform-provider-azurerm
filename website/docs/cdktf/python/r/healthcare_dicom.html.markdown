...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_healthcare_workspace_test =
        azurerm.healthcare_workspace.HealthcareWorkspace(self, "test",
            location="east us",
            name="tfexworkspace",
            resource_group_name="tfex-resource_group"
        )
        azurerm_healthcare_dicom_service_test =
        azurerm.healthcare_dicom_service.HealthcareDicomService(self, "test_1",
            ...
            workspace_id=cdktf.Token.as_string(azurerm_healthcare_workspace_test.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_healthcare_dicom_service_test.override_logical_id("test")
```
