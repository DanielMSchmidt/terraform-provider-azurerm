    ...
    def __init__(self, scope, name):
        ...
        azurerm.media_content_key_policy.MediaContentKeyPolicy(self, "example_3",
            ...
            policy_option=[MediaContentKeyPolicyPolicyOption(
                ...
                name="playReady",
                open_restriction_enabled=True,
                playready_configuration_license=[MediaContentKeyPolicyPolicyOptionPlayreadyConfigurationLicense(
                ...
                token_restriction=MediaContentKeyPolicyPolicyOptionTokenRestriction(
                    alternate_key=[MediaContentKeyPolicyPolicyOptionTokenRestrictionAlternateKey(
                ...
                name="widevine",
                open_restriction_enabled=True,
                widevine_configuration_template=cdktf.Fn.jsonencode({
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-177b5d08feb18939185972388cf950952728151b5fcc3c0b0f86032e2a1348d4 -->