...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm_log_analytics_query_pack_query_example =
        azurerm.log_analytics_query_pack_query.LogAnalyticsQueryPackQuery(self, "example_2",
            ...
            query_pack_id=cdktf.Token.as_string(azurerm_log_analytics_query_pack_example.id)
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        azurerm_log_analytics_query_pack_query_example.override_logical_id("example")
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-1b25838b059728ee3a10ef48c22e0e6dc88d7dde0be8cfde41c072e5fb171342 -->