...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_application_insights_example =
        azurerm.data_azurerm_application_insights.DataAzurermApplicationInsights(self, "example",
            name="production",
            resource_group_name="networking"
        )
        cdktf.TerraformOutput(self, "application_insights_instrumentation_key",
            value=data_azurerm_application_insights_example.instrumentation_key
        )
```
