...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        cdktf.TerraformOutput(self, "storage_account_tier",
            value=data_azurerm_storage_account_example.account_tier
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-2e2abcf45b811a6ef8f3bf796b5259925ef714c2dc8363e8dc3f9cca1ce728e6 -->