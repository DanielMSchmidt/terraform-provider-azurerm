...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.data_azurerm_batch_pool.DataAzurermBatchPool(self, "example",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-28b771a24d8ca5908e3bea53b1a94255f1f9fa0bd67e9050b9e4b3b2e46854e5 -->