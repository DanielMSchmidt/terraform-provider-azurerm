...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_healthcare_fhir_service_example =
        azurerm.data_azurerm_healthcare_fhir_service.DataAzurermHealthcareFhirService(self, "example",
            name="example-healthcare",
            workspace_id=cdktf.Token.as_string(data_azurerm_healthcare_fhir_service_example.workspace_id)
        )
        cdktf.TerraformOutput(self, "healthcare_fhir_service_id",
            value=data_azurerm_healthcare_fhir_service_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6bc39035e2ffa161a9fbda42f353022ef82f4f89f3ea3b3356e01516f04c3087 -->