...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_virtual_machine_scale_set_example =
        azurerm.data_azurerm_virtual_machine_scale_set.DataAzurermVirtualMachineScaleSet(self, "example",
            name="existing",
            resource_group_name="existing"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_virtual_machine_scale_set_example.id
        )
```
