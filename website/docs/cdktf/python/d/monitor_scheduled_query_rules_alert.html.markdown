...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_monitor_scheduled_query_rules_alert_example =
        azurerm.data_azurerm_monitor_scheduled_query_rules_alert.DataAzurermMonitorScheduledQueryRulesAlert(self, "example",
            name="tfex-queryrule",
            resource_group_name="terraform-example-rg"
        )
        cdktf.TerraformOutput(self, "query_rule_id",
            value=data_azurerm_monitor_scheduled_query_rules_alert_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-cb4deaca82af76f705ff6b8486713f4c4a3c6a13efecbfcf029c71c718e7ba13 -->