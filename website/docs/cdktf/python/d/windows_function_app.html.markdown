...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_windows_function_app_example =
        azurerm.data_azurerm_windows_function_app.DataAzurermWindowsFunctionApp(self, "example",
            name="existing",
            resource_group_name="existing"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_windows_function_app_example.id
        )
```
