...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_servicebus_namespace_example =
        azurerm.data_azurerm_servicebus_namespace.DataAzurermServicebusNamespace(self, "example",
            name="examplenamespace",
            resource_group_name="example-resources"
        )
        cdktf.TerraformOutput(self, "location",
            value=data_azurerm_servicebus_namespace_example.location
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0c7780ec91ad14d23ab63150ceb53d51fdb92445f60d4e064152212724318112 -->