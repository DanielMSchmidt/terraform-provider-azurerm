...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_managed_disk_existing =
        azurerm.data_azurerm_managed_disk.DataAzurermManagedDisk(self, "existing",
            name="example-datadisk",
            resource_group_name="example-resources"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_managed_disk_existing.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d06de90edc1545df04438142a2b84ce881b74751e02f3a13256c4445164a0267 -->