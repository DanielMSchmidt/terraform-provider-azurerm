...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_automation_variable_datetime_example =
        azurerm.data_azurerm_automation_variable_datetime.DataAzurermAutomationVariableDatetime(self, "example",
            automation_account_name="tfex-example-account",
            name="tfex-example-var",
            resource_group_name="tfex-example-rg"
        )
        cdktf.TerraformOutput(self, "variable_id",
            value=data_azurerm_automation_variable_datetime_example.id
        )
```
