...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_network_interface_example =
        azurerm.data_azurerm_network_interface.DataAzurermNetworkInterface(self, "example",
            name="acctest-nic",
            resource_group_name="networking"
        )
        cdktf.TerraformOutput(self, "network_interface_id",
            value=data_azurerm_network_interface_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-56212613ccd77e3224beab8b09249412d5282f2cbbdbb6b97f6faed0e3a6e051 -->