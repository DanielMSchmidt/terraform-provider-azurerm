...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_servicebus_queue_example =
        azurerm.data_azurerm_servicebus_queue.DataAzurermServicebusQueue(self, "example",
            name="existing",
            namespace_name="existing",
            resource_group_name="existing"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_servicebus_queue_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9ee63082791d4db03e3b24badcbb6ad549abfb1fc43b151f44855f184167f61a -->