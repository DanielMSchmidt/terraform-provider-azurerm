...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_app_service_plan_example =
        azurerm.data_azurerm_app_service_plan.DataAzurermAppServicePlan(self, "example",
            name="search-app-service-plan",
            resource_group_name="search-service"
        )
        cdktf.TerraformOutput(self, "app_service_plan_id",
            value=data_azurerm_app_service_plan_example.id
        )
```
