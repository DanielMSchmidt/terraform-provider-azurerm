...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_image_search =
        azurerm.data_azurerm_image.DataAzurermImage(self, "search",
            name="search-api",
            resource_group_name="packerimages"
        )
        cdktf.TerraformOutput(self, "image_id",
            value=data_azurerm_image_search.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-1ce2480cae1984df531266eff993ccbe10e06dfe7dcdf1bdfbb6ba3ed7a24d21 -->