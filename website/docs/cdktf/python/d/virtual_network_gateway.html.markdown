...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.data_azurerm_virtual_network_gateway.DataAzurermVirtualNetworkGateway(self, "example",
            name="production",
            resource_group_name="networking"
        )
        cdktf.TerraformOutput(self, "virtual_network_gateway_id",
            value=data_azurerm_virtual_network_gateway_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-869d42a03a1daf05850a2420e3332cae6fc1bf193ffe1921c15fd80f170b1269 -->