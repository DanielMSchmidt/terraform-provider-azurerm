...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_app_service_example =
        azurerm.data_azurerm_app_service.DataAzurermAppService(self, "example",
            name="search-app-service",
            resource_group_name="search-service"
        )
        cdktf.TerraformOutput(self, "app_service_id",
            value=data_azurerm_app_service_example.id
        )
```
