...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.data_azurerm_kubernetes_cluster.DataAzurermKubernetesCluster(self, "example",
            name="myakscluster",
        ...
        kubernetes.provider.KubernetesProvider(self, "kubernetes",
            client_certificate=cdktf.Fn.base64decode(
                cdktf.Token.as_string(
                    cdktf.property_access(data_azurerm_kubernetes_cluster_main.kube_config, ["0", "client_certificate"
                    ]))),
            client_key=cdktf.Fn.base64decode(
                cdktf.Token.as_string(
                    cdktf.property_access(data_azurerm_kubernetes_cluster_main.kube_config, ["0", "client_key"
                    ]))),
            cluster_ca_certificate=cdktf.Fn.base64decode(
                cdktf.Token.as_string(
                    cdktf.property_access(data_azurerm_kubernetes_cluster_main.kube_config, ["0", "cluster_ca_certificate"
                    ]))),
            host=cdktf.property_access(data_azurerm_kubernetes_cluster_main.kube_config, ["0", "host"
            ]),
            password=cdktf.property_access(data_azurerm_kubernetes_cluster_main.kube_config, ["0", "password"]),
            username=cdktf.property_access(data_azurerm_kubernetes_cluster_main.kube_config, ["0", "username"])
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0c4e8b1343b20814ed1227960395cadced3fa4f460f35704b44bf52a5d2dc370 -->