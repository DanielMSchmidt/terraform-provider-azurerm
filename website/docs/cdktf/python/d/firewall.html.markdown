...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_firewall_example =
        azurerm.data_azurerm_firewall.DataAzurermFirewall(self, "example",
            name="firewall1",
            resource_group_name="firewall-RG"
        )
        cdktf.TerraformOutput(self, "firewall_private_ip",
            value=cdktf.property_access(data_azurerm_firewall_example.ip_configuration, ["0", "private_ip_address"
            ])
        )
```
