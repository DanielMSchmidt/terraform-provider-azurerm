...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_kubernetes_cluster_node_pool_example =
        azurerm.data_azurerm_kubernetes_cluster_node_pool.DataAzurermKubernetesClusterNodePool(self, "example",
            kubernetes_cluster_name="existing-cluster",
            name="existing",
            resource_group_name="existing-resource-group"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_kubernetes_cluster_node_pool_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6b42528c0f0c45c2788abc2720db6ee6fbe8072b7ede318702a63a70c1496f35 -->