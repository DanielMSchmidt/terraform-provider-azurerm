...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_traffic_manager_profile_example =
        azurerm.data_azurerm_traffic_manager_profile.DataAzurermTrafficManagerProfile(self, "example",
            name="test",
            resource_group_name="test"
        )
        cdktf.TerraformOutput(self, "traffic_routing_method",
            value=data_azurerm_traffic_manager_profile_example.traffic_routing_method
        )
```
