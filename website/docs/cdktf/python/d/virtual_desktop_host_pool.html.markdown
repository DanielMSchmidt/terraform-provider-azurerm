...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.data_azurerm_virtual_desktop_host_pool.DataAzurermVirtualDesktopHostPool(self, "example",
            name="example-pool",
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d504d8e31189889ac358ab2395a79c41f0e2b7acf3222063f862cb4245b6bcd4 -->