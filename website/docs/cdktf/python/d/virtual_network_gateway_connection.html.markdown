...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_virtual_network_gateway_connection_example =
        azurerm.data_azurerm_virtual_network_gateway_connection.DataAzurermVirtualNetworkGatewayConnection(self, "example",
            name="production",
            resource_group_name="networking"
        )
        cdktf.TerraformOutput(self, "virtual_network_gateway_connection_id",
            value=data_azurerm_virtual_network_gateway_connection_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d9b07f47de7d4faf40ce02f2915eacbade1a59e8cc591c918a96eba3ceee3b32 -->