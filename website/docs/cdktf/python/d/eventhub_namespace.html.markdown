...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_eventhub_namespace_example =
        azurerm.data_azurerm_eventhub_namespace.DataAzurermEventhubNamespace(self, "example",
            name="search-eventhubns",
            resource_group_name="search-service"
        )
        cdktf.TerraformOutput(self, "eventhub_namespace_id",
            value=data_azurerm_eventhub_namespace_example.id
        )
```
