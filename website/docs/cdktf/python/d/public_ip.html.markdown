...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_public_ip_example =
        azurerm.data_azurerm_public_ip.DataAzurermPublicIp(self, "example",
            name="name_of_public_ip",
            resource_group_name="name_of_resource_group"
        )
        cdktf.TerraformOutput(self, "domain_name_label",
            value=data_azurerm_public_ip_example.domain_name_label
        )
        cdktf.TerraformOutput(self, "public_ip_address",
            value=data_azurerm_public_ip_example.ip_address
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-dbe200a5d01f9a77d78cbf95db9384972fff6b60e7d0f25e7b833ff893db2d28 -->