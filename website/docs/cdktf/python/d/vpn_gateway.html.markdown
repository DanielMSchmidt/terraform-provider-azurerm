...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_vpn_gateway_example =
        azurerm.data_azurerm_vpn_gateway.DataAzurermVpnGateway(self, "example",
            name="existing-local-vpn_gateway",
            resource_group_name="existing-vpn_gateway"
        )
        cdktf.TerraformOutput(self, "azurerm_vpn_gateway_id",
            value=data_azurerm_vpn_gateway_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-628ef028bc877f03e5e2db55588b37acf395be886172bc624b7493ffd8c310f9 -->