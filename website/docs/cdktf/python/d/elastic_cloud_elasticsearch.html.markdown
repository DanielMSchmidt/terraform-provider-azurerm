...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_elastic_cloud_elasticsearch_example =
        azurerm.data_azurerm_elastic_cloud_elasticsearch.DataAzurermElasticCloudElasticsearch(self, "example",
            name="my-elastic-search",
            resource_group_name="example-resources"
        )
        cdktf.TerraformOutput(self, "elasticsearch_endpoint",
            value=data_azurerm_elastic_cloud_elasticsearch_example.elasticsearch_service_url
        )
        cdktf.TerraformOutput(self, "kibana_endpoint",
            value=data_azurerm_elastic_cloud_elasticsearch_example.kibana_service_url
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-6068fc6b5d7999c49dc5600b4e08ea2b2312820fda260024c3e0235a551c266f -->