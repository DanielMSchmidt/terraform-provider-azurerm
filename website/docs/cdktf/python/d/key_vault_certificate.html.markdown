...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_key_vault_certificate_example =
        azurerm.data_azurerm_key_vault_certificate.DataAzurermKeyVaultCertificate(self, "example_1",
            key_vault_id=cdktf.Token.as_string(data_azurerm_key_vault_example.id),
            name="secret-sauce"
        )
        # This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.
        data_azurerm_key_vault_certificate_example.override_logical_id("example")
        cdktf.TerraformOutput(self, "certificate_thumbprint",
            value=data_azurerm_key_vault_certificate_example.thumbprint
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-ed7c17abcd1317a9faf682a9455d19c00cb5da6285d1e111265a821f76f58827 -->