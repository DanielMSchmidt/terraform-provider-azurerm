...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_hybrid_compute_machine_example =
        azurerm.data_azurerm_hybrid_compute_machine.DataAzurermHybridComputeMachine(self, "example",
            name="existing-hcmachine",
            resource_group_name="existing-rg"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_hybrid_compute_machine_example.id
        )
```
