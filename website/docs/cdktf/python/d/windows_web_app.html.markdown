...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_windows_web_app_example =
        azurerm.data_azurerm_windows_web_app.DataAzurermWindowsWebApp(self, "example",
            name="existing",
            resource_group_name="existing"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_windows_web_app_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-a284a328f2f675bb6d30d5f20b533397f047e547b60f198534ab8b5c10c226fa -->