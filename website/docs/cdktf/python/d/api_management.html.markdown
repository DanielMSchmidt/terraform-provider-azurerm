...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        cdktf.TerraformOutput(self, "api_management_id",
            value=data_azurerm_api_management_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-62c8fc431e5cc3027ff3e630da278e0f1704e9725a62857144fc2bad632c16f8 -->