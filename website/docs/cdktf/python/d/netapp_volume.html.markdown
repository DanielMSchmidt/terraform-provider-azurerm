...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_netapp_volume_example =
        azurerm.data_azurerm_netapp_volume.DataAzurermNetappVolume(self, "example",
            account_name="acctestnetappaccount",
            name="example-volume",
            pool_name="acctestnetapppool",
            resource_group_name="acctestRG"
        )
        cdktf.TerraformOutput(self, "netapp_volume_id",
            value=data_azurerm_netapp_volume_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-8ae0989acca8622934bf3eaafbe00b5dc644ca2537fee895aab67332928b3288 -->