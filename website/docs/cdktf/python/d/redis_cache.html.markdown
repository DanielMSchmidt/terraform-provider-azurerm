...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_redis_cache_example =
        azurerm.data_azurerm_redis_cache.DataAzurermRedisCache(self, "example",
            name="myrediscache",
            resource_group_name="redis-cache"
        )
        cdktf.TerraformOutput(self, "hostname",
            value=data_azurerm_redis_cache_example.hostname
        )
        cdktf.TerraformOutput(self, "primary_access_key",
            value=data_azurerm_redis_cache_example.primary_access_key
        )
```
