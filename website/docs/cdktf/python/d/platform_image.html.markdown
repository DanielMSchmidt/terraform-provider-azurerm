...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_platform_image_example =
        azurerm.data_azurerm_platform_image.DataAzurermPlatformImage(self, "example",
        ...
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_platform_image_example.id
        )
```
