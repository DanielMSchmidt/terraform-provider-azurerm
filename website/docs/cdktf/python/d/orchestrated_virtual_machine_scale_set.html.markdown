...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_orchestrated_virtual_machine_scale_set_example =
        azurerm.data_azurerm_orchestrated_virtual_machine_scale_set.DataAzurermOrchestratedVirtualMachineScaleSet(self, "example",
            name="existing",
            resource_group_name="existing"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_orchestrated_virtual_machine_scale_set_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-d28931e9e5c71d52fc0c7408b2d411050d3a2d8777a590b3fcf740180c44ea58 -->