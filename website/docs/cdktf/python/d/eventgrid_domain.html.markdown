...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_eventgrid_domain_example =
        azurerm.data_azurerm_eventgrid_domain.DataAzurermEventgridDomain(self, "example",
            name="my-eventgrid-domain",
            resource_group_name="example-resources"
        )
        cdktf.TerraformOutput(self, "eventgrid_domain_mapping_topic",
            value=cdktf.property_access(data_azurerm_eventgrid_domain_example.input_mapping_fields, ["0", "topic"])
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-639b18a35ab8a54900e5db0431ae26464ca7b8e4850071295602e76b6f57b4e1 -->