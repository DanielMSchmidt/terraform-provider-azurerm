...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_app_service_environment_v3_example =
        azurerm.data_azurerm_app_service_environment_v3.DataAzurermAppServiceEnvironmentV3(self, "example",
            name="example-ASE",
            resource_group_name="example-resource-group"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_app_service_environment_v3_example.id
        )
```
