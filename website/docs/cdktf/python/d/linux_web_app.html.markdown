...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_linux_web_app_example =
        azurerm.data_azurerm_linux_web_app.DataAzurermLinuxWebApp(self, "example",
            name="existing",
            resource_group_name="existing"
        )
        cdktf.TerraformOutput(self, "id",
            value=data_azurerm_linux_web_app_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-f58e645a38b7d3762bcdc7a807a5b03a7642f6f0d7691145e1204a7b066d8b17 -->