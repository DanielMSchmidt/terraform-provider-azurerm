...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        data_azurerm_monitor_action_group_example =
        azurerm.data_azurerm_monitor_action_group.DataAzurermMonitorActionGroup(self, "example",
            name="tfex-actiongroup",
            resource_group_name="terraform-example-rg"
        )
        cdktf.TerraformOutput(self, "action_group_id",
            value=data_azurerm_monitor_action_group_example.id
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-bb1edbc376b240fb63b2415f5d84982a0cb088f1633974df30a7d52143e63c6d -->