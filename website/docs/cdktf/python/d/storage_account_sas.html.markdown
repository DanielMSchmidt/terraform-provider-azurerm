...
class MyConvertedCode(cdktf.TerraformStack):
    def __init__(self, scope, name):
        ...
        azurerm.data_azurerm_storage_account_sas.DataAzurermStorageAccountSas(self, "example_2",
        ...
        cdktf.TerraformOutput(self, "sas_url_query_string",
            value=data_azurerm_storage_account_sas_example.sas
        )
```
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-e16265ec57fdb7be04970c84f390c65c3d5988792be0e7ae6dcc16678b84ff17 -->