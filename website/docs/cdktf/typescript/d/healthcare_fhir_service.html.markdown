...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const dataAzurermHealthcareFhirServiceExample =
      new azurerm.dataAzurermHealthcareFhirService.DataAzurermHealthcareFhirService(
        this,
        "example",
        {
          name: "example-healthcare",
          workspaceId: cdktf.Token.asString(
            dataAzurermHealthcareFhirServiceExample.workspaceId
          ),
        }
      );
    new cdktf.TerraformOutput(this, "healthcare_fhir_service_id", {
      value: dataAzurermHealthcareFhirServiceExample.id,
    });
  }
}
