    ...
    new kubernetes.provider.KubernetesProvider(this, "kubernetes", {
      client_certificate: cdktf.Fn.base64decode(
        cdktf.Token.asString(
          cdktf.propertyAccess(dataAzurermKubernetesClusterMain.kubeConfig, [
            "0",
            "client_certificate",
          ])
        )
      ...
      host: cdktf.propertyAccess(dataAzurermKubernetesClusterMain.kubeConfig, [
        "0",
        "host",
      ]),
      password: cdktf.propertyAccess(
        dataAzurermKubernetesClusterMain.kubeConfig,
        ["0", "password"]
      ),
      username: cdktf.propertyAccess(
        dataAzurermKubernetesClusterMain.kubeConfig,
        ["0", "username"]
      ),
    });
