...
-> **Note:** The  Data Source `azurermHybridComputeMachine` is deprecated will be removed in v4.0 of the Azure Provider - a replacement can be found in the form of the [`azurermArcMachine`](arc_machine.html) Data Source.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-ed1daee04bd1ec1ca2c195f4314137a92636c3b4c36bc15766dcbe5aec37942b -->