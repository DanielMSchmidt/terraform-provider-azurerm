...
* `webPubsubId` - (Required) The Web PubSub ID of the Web PubSub Custom Certificate. Changing this forces a new resource to be created.
...
* `customCertificateId` - (Required) The certificate ID of the Web PubSub Custom Certificate. Changing this forces a new resource to be created.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9f0bf0ea7c1559b8722114845186412e8f1a61408b2b3d871f059ef3b258fb7d -->