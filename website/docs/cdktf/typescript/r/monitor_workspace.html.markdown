...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const azurermMonitorWorkspaceExample =
      new azurerm.monitorWorkspace.MonitorWorkspace(this, "example_1", {
        location: "West Europe",
        name: "example-mamw",
...
* `resourceGroupName` - (Required) Specifies the name of the Resource Group where the Azure Monitor Workspace should exist. Changing this forces a new resource to be created.
