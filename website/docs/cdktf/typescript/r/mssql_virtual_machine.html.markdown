    ...
    const azurermMssqlVirtualMachineExample =
      new azurerm.mssqlVirtualMachine.MssqlVirtualMachine(this, "example_1", {
        ...
        virtualMachineId: cdktf.Token.asString(
          dataAzurermVirtualMachineExample.id
        ),
      });
...
* `sqlLicenseType` - (Optional) The SQL Server license type. Possible values are `ahub` (Azure Hybrid Benefit), `dr` (Disaster Recovery), and `payg` (Pay-As-You-Go). Changing this forces a new resource to be created.
