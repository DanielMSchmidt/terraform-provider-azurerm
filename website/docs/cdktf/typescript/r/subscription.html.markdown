...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const azurermSubscriptionExample = new azurerm.subscription.Subscription(
      ...
      "example_1",
      {
        billingScopeId: cdktf.Token.asString(
          dataAzurermBillingEnrollmentAccountScopeExample.id
        ),
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const azurermSubscriptionExample = new azurerm.subscription.Subscription(
      ...
      {
        billingScopeId: cdktf.Token.asString(
          dataAzurermBillingMcaAccountScopeExample.id
        ),
...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const azurermSubscriptionExample = new azurerm.subscription.Subscription(
      ...
      {
        billingScopeId: cdktf.Token.asString(
          dataAzurermBillingMpaAccountScopeExample.id
        ),
