    ...
    const azurermStreamAnalyticsOutputServicebusTopicExample =
      new azurerm.streamAnalyticsOutputServicebusTopic.StreamAnalyticsOutputServicebusTopic(
        ...
        "example_4",
        {
          ...
          topicName: cdktf.Token.asString(azurermServicebusTopicExample.name),
        }
      );
    /*This allows the Terraform resource name to match the original name. You can remove the call if you don't need them to match.*/
    azurermStreamAnalyticsOutputServicebusTopicExample.overrideLogicalId(
      "example"
    );
  }
}
