...
-> **NOTE:**  Please note that storage accounts configured with `shared_access_key_enabled = false` cannot be used to configure `azurermMssqlManagedInstanceSecurityAlertPolicy` with `storageEndpoint` for now.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-841ae198fa83d1098a80d3fdbaf392fcc5f241a30cbb64aa4d294b6ec5c94753 -->