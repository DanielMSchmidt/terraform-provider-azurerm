...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    super(scope, name);
    const dataAzurermImageExisting =
      new azurerm.dataAzurermImage.DataAzurermImage(this, "existing", {
        name: "search-api",
    ...
    new azurerm.sharedImageVersion.SharedImageVersion(this, "example", {
      galleryName: cdktf.Token.asString(
        dataAzurermSharedImageExisting.galleryName
      ),
      imageName: cdktf.Token.asString(dataAzurermSharedImageExisting.name),
      location: cdktf.Token.asString(dataAzurermSharedImageExisting.location),
      managedImageId: cdktf.Token.asString(dataAzurermImageExisting.id),
      name: "0.0.1",
      resourceGroupName: cdktf.Token.asString(
        dataAzurermSharedImageExisting.resourceGroupName
      ),
      targetRegion: [
        {
          name: cdktf.Token.asString(dataAzurermSharedImageExisting.location),
