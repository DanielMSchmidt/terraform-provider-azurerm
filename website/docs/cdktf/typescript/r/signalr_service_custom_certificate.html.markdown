...
* `signalrServiceId` - (Required) The SignalR ID of the SignalR Custom Certificate. Changing this forces a new resource to be created.
...
* `customCertificateId` - (Required) The certificate id of the SignalR Custom Certificate service. Changing this forces a new resource to be created.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-5d6b3dc2e247ef44f7cd346564c802b6ea26d4cec293c5a8c4ed02a7e85ff074 -->