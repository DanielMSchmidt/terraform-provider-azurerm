...
* `openidConfigurationEndpoint` - (Required) Specifies the endpoint used for OpenID Connect Discovery. For example `https://exampleCom/WellKnown/openidConfiguration`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-04fc0fbd2e7fb431a9b54033c60562bbbbfca55fd45807b61aa91ff778ab3267 -->