...
* `aofBackupEnabled` - (Optional) Enable or disable AOF persistence for this Redis Cache. Defaults to `false`.
...
* `rdbBackupEnabled` - (Optional) Is Backup Enabled? Only supported on Premium SKUs. Defaults to `false`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-297728035c559f2fac01810ce1059035a7f7d6754e973c434d4f6bc3dbeb8e70 -->