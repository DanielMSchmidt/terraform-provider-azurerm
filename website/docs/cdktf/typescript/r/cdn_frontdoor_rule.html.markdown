...
* `negateCondition` - (Optional) If `true` operator becomes the opposite of its value. Possible values `true` or `false`. Defaults to `false`. Details can be found in the `Condition Operator List` below.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-9c5172c8fcc5687a66f62226720c69d7dda9a914f4f4ca85f66133b7d22e612b -->