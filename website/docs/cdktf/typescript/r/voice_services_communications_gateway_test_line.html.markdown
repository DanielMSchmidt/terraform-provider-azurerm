...
* `voiceServicesCommunicationsGatewayId` - (Required) Specifies the ID of the Voice Services Communications Gateway. Changing this forces a new resource to be created.

* `phoneNumber` - (Required) Specifies the phone number.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-fa3f96c76ed16ca8f54d3a6ea61d9d77a2a4f6759d26dc786264af7baceb048b -->