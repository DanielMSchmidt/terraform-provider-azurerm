...
* `appCommandLine` - (Optional) The program and any arguments used to launch this app via the command line. (Example `node myapp.js`).
...
* `possibleOutboundIpAddresses` - A comma separated list of possible outbound IP addresses as a string. For example `5223253,521434312,521434317`. This is a superset of `outboundIpAddresses`. For example `["52.23.25.3", "52.143.43.12","52.143.43.17"]`.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-246c4ff9ec70474ce184ad7da057d14c44e8e9ed369946073cc501e098f00cbf -->