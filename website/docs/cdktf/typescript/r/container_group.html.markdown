...
class MyConvertedCode extends cdktf.TerraformStack {
  constructor(scope: constructs.Construct, name: string) {
    ...
    const azurermContainerGroupExample =
      new azurerm.containerGroup.ContainerGroup(this, "example_1", {
        container: [
          {
            cpu: cdktf.Token.asNumber("0.5"),
            image: "mcr.microsoft.com/azuredocs/aci-helloworld:latest",
            memory: cdktf.Token.asNumber("1.5"),
            name: "hello-world",
            ports: [
              {
                port: 443,
...
~> **Note:** Removing all `exposedPort` blocks requires setting `exposed_port = []`.
...
* `httpGet` - (Optional) The definition of the http_get for this container as documented in the `httpGet` block below. Changing this forces a new resource to be created.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-68b43408f85576f1fdd234e960ca8123e1dac4e560bc9e7909df4724f174667c -->