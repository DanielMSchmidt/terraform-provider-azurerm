...
* `vaultId` - (Required) ID of the Recovery Services Vault which should be associated with. Changing this forces a new resource to be created.

* `resourceGuardId` - (Required) ID of the Resource Guard which should be associated with. Changing this forces a new resource to be created. 
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-c146c4ab0e628b51ab13ba7e0575fe1f855b0894bbb35c587bd1cf1c8e3ddce8 -->