    ...
    const azurermDevTestWindowsVirtualMachineExample =
      new azurerm.devTestWindowsVirtualMachine.DevTestWindowsVirtualMachine(
        ...
        "example_3",
        {
          ...
          labName: cdktf.Token.asString(azurermDevTestLabExample.name),
          labSubnetName: cdktf.Token.asString(
            cdktf.propertyAccess(azurermDevTestVirtualNetworkExample.subnet, [
              "0",
              "name",
            ])
          ),
          labVirtualNetworkId: cdktf.Token.asString(
            azurermDevTestVirtualNetworkExample.id
          ),
          location: cdktf.Token.asString(azurermResourceGroupExample.location),
          name: "example-vm03",
