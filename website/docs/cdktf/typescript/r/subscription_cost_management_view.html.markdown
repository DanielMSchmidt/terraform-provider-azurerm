...
* `subscriptionId` - (Required) The ID of the Subscription this View is scoped to. Changing this forces a new Cost Management View for a Subscription to be created.
...
* `columnName` - (Required) The name of the column to aggregate. Changing this forces a new Cost Management View for a Subscription to be created.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-b833b4240d348294e4df3d6b4236b2ae94e44f9056749493dbef9e6cb4dd00f7 -->