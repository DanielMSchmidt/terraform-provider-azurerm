...
~> **Note:** Using this value requires either `websiteRunFromPackage=1` or `scmDoBuildDuringDeployment=true` to be set on the App in `appSettings`. Refer to the [Azure docs](https://learn.microsoft.com/en-us/azure/azure-functions/functions-deployment-technologies) for further details.
...
<!-- cache-key: cdktf-0.17.0-pre.15 input-0d6362c4397ae354f4149c43304978162698ccad7f78e8e2e247fa5690318241 -->